...
export const settingsEn = {
  ...
  loyalty: {
    scope: 'Applies to the whole chain',
    earnTitle: 'Earning',
    earnPer: 'For every',
    earnPoints: 'The customer gets',
    point: 'points',
    earnExample: 'A {amount} order earns {points} points.',
    redeemTitle: 'Redeeming',
    redeemRate: 'One point is worth',
    redeemExample: '{points} points redeem {amount}, which is {percent} percent back.',
    tierTitle: 'Earn multiplier per tier',
    tierHint: 'Left empty every tier is x 1.0 and the rule behaves as before.',
    tierExample: 'A {amount} order for a {tier} customer earns {base} x {multiplier} = {points} points, rounded down.',
    thresholdTitle: 'Tier thresholds by lifetime spend',
    tier: {
      bronze: 'Bronze',
      silver: 'Silver',
      gold: 'Gold',
