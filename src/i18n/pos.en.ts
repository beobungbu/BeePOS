...
export const posEn = {
  ...
  wholesale: {
    toggle: 'Wholesale',
    badge: 'W/S',
    hint: "Applies the buyer's price list, shows unit conversion and enables on-account payment.",
    salesRep: 'Sales rep',
    salesRepNone: 'Unassigned',
    noCustomer: 'Attach a company customer to apply wholesale prices',
    retailCustomer: 'A retail customer has no wholesale price list',
    term: 'due',
    termDays: 'days',
    unit: 'Unit',
    unitBase: 'single',
    minOrderPrefix: 'Minimum',
    minOrderSuffix: 'per wholesale order',
    ...
    vat: {
      ...
      address: 'Address',
      email: 'Invoice email',
      missing: 'Buyer details incomplete',
      dialogTitle: 'VAT invoice details',
      save: 'Save details',
    },
    account: {
      method: 'On account',
      ...
      dueDate: 'Due date',
      blockedNoLimit: 'This buyer has no credit limit, so nothing can go on account.',
      blockedOverLimit: 'This order would exceed the remaining credit limit.',
      needCompany: 'Only company customers may buy on account',
      recorded: 'Order put on account',
    },
  },
