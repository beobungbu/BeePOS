// Renders the phase 7 mockups to PNG for review.
// Run from the repo root: node plans/260913-1115-beepos-commerce-program/shoot-phase7.js
...
const pages = process.argv.slice(2).length ? process.argv.slice(2) : ["commerce-sales", "commerce-ops"];
